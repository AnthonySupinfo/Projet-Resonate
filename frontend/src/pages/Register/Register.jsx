...
export default function Register() {
  ...
  async function handleStep2(e) {
    ...
    setLoading(true)
    try {
      const avatarUrl = selectedAvatar ? selectedAvatar.emoji : null
              ...
              <div className="form-group avatar-form-group">
                ...
                <div className="avatar-picker">
                  <div className="avatar-trigger" onClick={() => setAvatarDropdownOpen(o => !o)}>
                    <div className="avatar-trigger__circle" style={{ backgroundColor: selectedAvatar ? selectedAvatar.bg : "#d1d5db" }}>
